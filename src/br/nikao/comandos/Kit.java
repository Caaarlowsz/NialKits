...
/*      */ {
	...
	/*      */ {
		...
		/*      */
		/* 24 */ if (args.length == 0) {
			/* 25 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §cUse: /kit <kit> ou /kits");
			/* 26 */ return true;
			/*      */ }
			...
			/* 29 */ if (p.hasPermission("kit.pvp")) {
				/* 30 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 37 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 46 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §ePvP");
					/* 47 */ return true;
					/*      */ }
				/* 49 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 50 */ return true;
				/*      */ }
			/*      */
			/* 53 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 54 */ return true;
			/*      */ }
		/*      */
		/*      */
			...
			/* 59 */ if (p.hasPermission("kit.archer")) {
				/* 60 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 67 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 76 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eArcher");
					/* 77 */ return true;
					/*      */ }
				/* 79 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 80 */ return true;
				/*      */ }
			/*      */
			/* 83 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 84 */ return true;
			/*      */ }
		/*      */
			...
			/* 89 */ if (p.hasPermission("kit.viper")) {
				/* 90 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 97 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 106 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eViper");
					/* 107 */ return true;
					/*      */ }
				/* 109 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 110 */ return true;
				/*      */ }
			/*      */
			/* 113 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 114 */ return true;
			/*      */ }
		/*      */
			...
			/* 119 */ if (p.hasPermission("kit.kangaroo")) {
				/* 120 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 127 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 136 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eKangaroo");
					/* 137 */ return true;
					/*      */ }
				/* 139 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 140 */ return true;
				/*      */ }
			/*      */
			/* 143 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 144 */ return true;
			/*      */ }
		/*      */
			...
			/* 149 */ if (p.hasPermission("kit.snail")) {
				/* 150 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 157 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 166 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eSnail");
					/* 167 */ return true;
					/*      */ }
				/* 169 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 170 */ return true;
				/*      */ }
			/*      */
			/* 173 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 174 */ return true;
			/*      */ }
		/*      */
			...
			/* 179 */ if (p.hasPermission("kit.anchor")) {
				/* 180 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 187 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 196 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eAnchor");
					/* 197 */ return true;
					/*      */ }
				/* 199 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 200 */ return true;
				/*      */ }
			/*      */
			/* 203 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 204 */ return true;
			/*      */ }
		/*      */
			...
			/* 209 */ if (p.hasPermission("kit.phantom")) {
				/* 210 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 217 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 226 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §ePhantom");
					/* 227 */ return true;
					/*      */ }
				/* 229 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 230 */ return true;
				/*      */ }
			/*      */
			/* 233 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 234 */ return true;
			/*      */ }
		/*      */
			...
			/* 239 */ if (p.hasPermission("kit.ninja")) {
				/* 240 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 247 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 256 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eNinja");
					/* 257 */ return true;
					/*      */ }
				/* 259 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 260 */ return true;
				/*      */ }
			/*      */
			/* 263 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 264 */ return true;
			/*      */ }
		/*      */
			...
			/* 269 */ if (p.hasPermission("kit.thor")) {
				/* 270 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 277 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 286 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eThor");
					/* 287 */ return true;
					/*      */ }
				/* 289 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 290 */ return true;
				/*      */ }
			/*      */
			/* 293 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 294 */ return true;
			/*      */ }
		/*      */
			...
			/* 299 */ if (p.hasPermission("kit.timelord")) {
				/* 300 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 307 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 316 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eTimelord");
					/* 317 */ return true;
					/*      */ }
				/* 319 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 320 */ return true;
				/*      */ }
			/*      */
			/* 323 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 324 */ return true;
			/*      */ }
		/*      */
			...
			/* 329 */ if (p.hasPermission("kit.fisherman")) {
				/* 330 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 337 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 346 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eFisherman");
					/* 347 */ return true;
					/*      */ }
				/* 349 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 350 */ return true;
				/*      */ }
			/*      */
			/* 353 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 354 */ return true;
			/*      */ }
		/*      */
			...
			/* 359 */ if (p.hasPermission("kit.fireman")) {
				/* 360 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 367 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 376 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eFireman");
					/* 377 */ return true;
					/*      */ }
				/* 379 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 380 */ return true;
				/*      */ }
			/*      */
			/* 383 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 384 */ return true;
			/*      */ }
		/*      */
			...
			/* 389 */ if (p.hasPermission("kit.barbarian")) {
				/* 390 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 397 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 406 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eBarbarian");
					/* 407 */ return true;
					/*      */ }
				/* 409 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 410 */ return true;
				/*      */ }
			/*      */
			/* 413 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 414 */ return true;
			/*      */ }
		/*      */
			...
			/* 419 */ if (p.hasPermission("kit.hulk")) {
				/* 420 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 427 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 436 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eHulk");
					/* 437 */ return true;
					/*      */ }
				/* 439 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 440 */ return true;
				/*      */ }
			/*      */
			/* 443 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 444 */ return true;
			/*      */ }
		/*      */
			...
			/* 449 */ if (p.hasPermission("kit.urgal")) {
				/* 450 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 457 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 466 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eUrgal");
					/* 467 */ return true;
					/*      */ }
				/* 469 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 470 */ return true;
				/*      */ }
			/*      */
			/* 473 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 474 */ return true;
			/*      */ }
		/*      */
			...
			/* 479 */ if (p.hasPermission("kit.viking")) {
				/* 480 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 487 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 496 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eViking");
					/* 497 */ return true;
					/*      */ }
				/* 499 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 500 */ return true;
				/*      */ }
			/*      */
			/* 503 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 504 */ return true;
			/*      */ }
		/*      */
			...
			/* 509 */ if (p.hasPermission("kit.grandpa")) {
				/* 510 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 517 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 526 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eGrandpa");
					/* 527 */ return true;
					/*      */ }
				/* 529 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 530 */ return true;
				/*      */ }
			/*      */
			/* 533 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 534 */ return true;
			/*      */ }
		/*      */
			...
			/* 539 */ if (p.hasPermission("kit.stomper")) {
				/* 540 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 547 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 556 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eStomper");
					/* 557 */ return true;
					/*      */ }
				/* 559 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 560 */ return true;
				/*      */ }
			/*      */
			/* 563 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 564 */ return true;
			/*      */ }
		/*      */
			...
			/* 569 */ if (p.hasPermission("kit.camel")) {
				/* 570 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 577 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 586 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eCamel");
					/* 587 */ return true;
					/*      */ }
				/* 589 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 590 */ return true;
				/*      */ }
			/*      */
			/* 593 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 594 */ return true;
			/*      */ }
		/*      */
			...
			/* 599 */ if (p.hasPermission("kit.critical")) {
				/* 600 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 607 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 616 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eCritical");
					/* 617 */ return true;
					/*      */ }
				/* 619 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 620 */ return true;
				/*      */ }
			/*      */
			/* 623 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 624 */ return true;
			/*      */ }
		/*      */
			...
			/* 629 */ if (p.hasPermission("kit.deshfire")) {
				/* 630 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 637 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 646 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eDeshfire");
					/* 647 */ return true;
					/*      */ }
				/* 649 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 650 */ return true;
				/*      */ }
			/*      */
			/* 653 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 654 */ return true;
			/*      */ }
		/*      */
			...
			/* 659 */ if (p.hasPermission("kit.endermage")) {
				/* 660 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 667 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 676 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eEndermage");
					/* 677 */ return true;
					/*      */ }
				/* 679 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 680 */ return true;
				/*      */ }
			/*      */
			/* 683 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 684 */ return true;
			/*      */ }
		/*      */
			...
			/* 689 */ if (p.hasPermission("kit.forcefield")) {
				/* 690 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 697 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 706 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eForceField");
					/* 707 */ return true;
					/*      */ }
				/* 709 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 710 */ return true;
				/*      */ }
			/*      */
			/* 713 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 714 */ return true;
			/*      */ }
		/*      */
			...
			/* 719 */ if (p.hasPermission("kit.frosty")) {
				/* 720 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 727 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 736 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eFrosty");
					/* 737 */ return true;
					/*      */ }
				/* 739 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 740 */ return true;
				/*      */ }
			/*      */
			/* 743 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 744 */ return true;
			/*      */ }
		/*      */
			...
			/* 749 */ if (p.hasPermission("kit.grappler")) {
				/* 750 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 757 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 766 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eGrappler");
					/* 767 */ return true;
					/*      */ }
				/* 769 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 770 */ return true;
				/*      */ }
			/*      */
			/* 773 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 774 */ return true;
			/*      */ }
		/*      */
			...
			/* 779 */ if (p.hasPermission("kit.launcher")) {
				/* 780 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 787 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 796 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eLauncher");
					/* 797 */ return true;
					/*      */ }
				/* 799 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 800 */ return true;
				/*      */ }
			/*      */
			/* 803 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 804 */ return true;
			/*      */ }
		/*      */
			...
			/* 809 */ if (p.hasPermission("kit.magma")) {
				/* 810 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 817 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 826 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eMagma");
					/* 827 */ return true;
					/*      */ }
				/* 829 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 830 */ return true;
				/*      */ }
			/*      */
			/* 833 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 834 */ return true;
			/*      */ }
		/*      */
			...
			/* 839 */ if (p.hasPermission("kit.monk")) {
				/* 840 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 847 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 856 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eMonk");
					/* 857 */ return true;
					/*      */ }
				/* 859 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 860 */ return true;
				/*      */ }
			/*      */
			/* 863 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 864 */ return true;
			/*      */ }
		/*      */
			...
			/* 869 */ if (p.hasPermission("kit.poseidon")) {
				/* 870 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 877 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 886 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §ePoseidon");
					/* 887 */ return true;
					/*      */ }
				/* 889 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 890 */ return true;
				/*      */ }
			/*      */
			/* 893 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 894 */ return true;
			/*      */ }
		/*      */
			...
			/* 899 */ if (p.hasPermission("kit.rain")) {
				/* 900 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 907 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 916 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eRain");
					/* 917 */ return true;
					/*      */ }
				/* 919 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 920 */ return true;
				/*      */ }
			/*      */
			/* 923 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 924 */ return true;
			/*      */ }
		/*      */
			...
			/* 929 */ if (p.hasPermission("kit.reaper")) {
				/* 930 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 937 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 946 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eReaper");
					/* 947 */ return true;
					/*      */ }
				/* 949 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 950 */ return true;
				/*      */ }
			/*      */
			/* 953 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 954 */ return true;
			/*      */ }
		/*      */
			...
			/* 959 */ if (p.hasPermission("kit.resouper")) {
				/* 960 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 967 */ if (Main.getInstance().getConfig().getString("TPKit").equals("true"))
						...
						/*      */ }
					/*      */
					/* 976 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
							+ " §6§l> §7§lO kit selecionado foi: §eResouper");
					/* 977 */ return true;
					/*      */ }
				/* 979 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 980 */ return true;
				/*      */ }
			/*      */
			/* 983 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 984 */ return true;
			/*      */ }
		/*      */
		...
		/* 988 */ if (args[0].equalsIgnoreCase("ryu")) {
			/* 989 */ if (p.hasPermission("kit.ryu")) {
				/* 990 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/*      */
					/* 1006 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eRyu");
					/* 1007 */ return true;
					/*      */ }
				/* 1009 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1010 */ return true;
				/*      */ }
			/*      */
			/* 1013 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1014 */ return true;
			/*      */ }
		/*      */
		...
		/* 1018 */ if (args[0].equalsIgnoreCase("specialist")) {
			/* 1019 */ if (p.hasPermission("kit.specialist")) {
				/* 1020 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1036 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eSpecialist");
					/* 1037 */ return true;
					/*      */ }
				/* 1039 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1040 */ return true;
				/*      */ }
			/*      */
			/* 1043 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1044 */ return true;
			/*      */ }
		/*      */
		...
		/* 1048 */ if (args[0].equalsIgnoreCase("spiderman")) {
			/* 1049 */ if (p.hasPermission("kit.spiderman")) {
				/* 1050 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1066 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eSpiderman");
					/* 1067 */ return true;
					/*      */ }
				/* 1069 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1070 */ return true;
				/*      */ }
			/*      */
			/* 1073 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1074 */ return true;
			/*      */ }
		/*      */
		...
		/* 1078 */ if (args[0].equalsIgnoreCase("switcher")) {
			/* 1079 */ if (p.hasPermission("kit.switcher")) {
				/* 1080 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1096 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eSwitcher");
					/* 1097 */ return true;
					/*      */ }
				/* 1099 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1100 */ return true;
				/*      */ }
			/*      */
			/* 1103 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1104 */ return true;
			/*      */ }
		/*      */
		...
		/* 1108 */ if (args[0].equalsIgnoreCase("turtle")) {
			/* 1109 */ if (p.hasPermission("kit.turtle")) {
				/* 1110 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1126 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eTurtle");
					/* 1127 */ return true;
					/*      */ }
				/* 1129 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1130 */ return true;
				/*      */ }
			/*      */
			/* 1133 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1134 */ return true;
			/*      */ }
		/*      */
		...
		/* 1138 */ if (args[0].equalsIgnoreCase("quickdropper")) {
			/* 1139 */ if (p.hasPermission("kit.quickdropper")) {
				/* 1140 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1156 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eQuickdropper");
					/* 1157 */ return true;
					/*      */ }
				/* 1159 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1160 */ return true;
				/*      */ }
			/*      */
			/* 1163 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1164 */ return true;
			/*      */ }
		/*      */
		...
		/* 1168 */ if (args[0].equalsIgnoreCase("c4")) {
			/* 1169 */ if (p.hasPermission("kit.c4")) {
				/* 1170 */ if (KitAPI.getkit(p) == "Nenhum") {
					...
					/* 1186 */ p
							.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
									+ " §6§l> §7§lO kit selecionado foi: §eC4");
					/* 1187 */ return true;
					/*      */ }
				/* 1189 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l> §cVocê já possui um Kit");
				/* 1190 */ return true;
				/*      */ }
			/*      */
			/* 1193 */ p.sendMessage(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
					+ " §6§l> §c§lSem permissão para pegar este Kit");
			/* 1194 */ return true;
			/*      */ }
		/*      */
