		...
		/* 28 */ if (args.length == 1) {
			/* 29 */ if (args[0].equalsIgnoreCase("1")) {
				/* 30 */ if (p.hasPermission("ng.kitpos")) {
					/* 31 */ Main.getInstance().getConfig().set("Warps.KitPos1World",
							p.getLocation().getWorld().getName());
					/* 32 */ Main.getInstance().getConfig().set("Warps.KitPos1X",
							Double.valueOf(p.getLocation().getX()));
					/* 33 */ Main.getInstance().getConfig().set("Warps.KitPos1Y",
							Double.valueOf(p.getLocation().getY()));
					/* 34 */ Main.getInstance().getConfig().set("Warps.KitPos1Z",
			...
			/* 44 */ if (args[0].equalsIgnoreCase("2")) {
				/* 45 */ if (p.hasPermission("ng.kitpos")) {
					/* 46 */ Main.getInstance().getConfig().set("Warps.KitPos2World",
							p.getLocation().getWorld().getName());
					/* 47 */ Main.getInstance().getConfig().set("Warps.KitPos2X",
							Double.valueOf(p.getLocation().getX()));
					/* 48 */ Main.getInstance().getConfig().set("Warps.KitPos2Y",
							Double.valueOf(p.getLocation().getY()));
					/* 49 */ Main.getInstance().getConfig().set("Warps.KitPos2Z",
							Double.valueOf(p.getLocation().getZ()));
			...
			/* 59 */ if (args[0].equalsIgnoreCase("3")) {
				/* 60 */ if (p.hasPermission("ng.kitpos")) {
					/* 61 */ Main.getInstance().getConfig().set("Warps.KitPos3World",
							p.getLocation().getWorld().getName());
					/* 62 */ Main.getInstance().getConfig().set("Warps.KitPos3X",
							Double.valueOf(p.getLocation().getX()));
					/* 63 */ Main.getInstance().getConfig().set("Warps.KitPos3Y",
							Double.valueOf(p.getLocation().getY()));
					/* 64 */ Main.getInstance().getConfig().set("Warps.KitPos3Z",
							Double.valueOf(p.getLocation().getZ()));
			...
			/* 74 */ if (args[0].equalsIgnoreCase("4")) {
				/* 75 */ if (p.hasPermission("ng.kitpos")) {
					/* 76 */ Main.getInstance().getConfig().set("Warps.KitPos4World",
							p.getLocation().getWorld().getName());
					/* 77 */ Main.getInstance().getConfig().set("Warps.KitPos4X",
							Double.valueOf(p.getLocation().getX()));
					/* 78 */ Main.getInstance().getConfig().set("Warps.KitPos4Y",
							Double.valueOf(p.getLocation().getY()));
					/* 79 */ Main.getInstance().getConfig().set("Warps.KitPos4Z",
							Double.valueOf(p.getLocation().getZ()));
			...
			/* 89 */ if (args[0].equalsIgnoreCase("5")) {
				/* 90 */ if (p.hasPermission("ng.kitpos")) {
					/* 91 */ Main.getInstance().getConfig().set("Warps.KitPos5World",
							p.getLocation().getWorld().getName());
					/* 92 */ Main.getInstance().getConfig().set("Warps.KitPos5X",
							Double.valueOf(p.getLocation().getX()));
					/* 93 */ Main.getInstance().getConfig().set("Warps.KitPos5Y",
							Double.valueOf(p.getLocation().getY()));
					/* 94 */ Main.getInstance().getConfig().set("Warps.KitPos5Z",
							Double.valueOf(p.getLocation().getZ()));
