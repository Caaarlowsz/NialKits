...
/*    */ {
	...
	/*    */ {
		...
		/* 28 */ (args[0].equalsIgnoreCase("brz"))) {
			...
			/* 32 */ p.sendMessage(
					"§6BRZ II - §eAo upar para o Rank BRZ IV você ganha o Kit: §aTimelord, Spiderman e Switcher");
			/* 33 */ p.sendMessage(
					"§6BRZ I - §eAo upar para o Rank BRZ IV você ganha o Kit: §aForcefield, Rain, Phantom e C4");
			/* 34 */ p.sendMessage(" ");
			/*    */ }
		/*    */
		/* 37 */ return false;
