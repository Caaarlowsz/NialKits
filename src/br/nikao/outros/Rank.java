...
/*    */ {
	...
	/*    */ {
		...
		/* 15 */ if (value == 1000) {
			...
			/* 19 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
		...
		/* 29 */ if (value == 3000) {
			...
			/* 33 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.deshfire");
			/* 34 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
		...
		/* 44 */ if (value == 5000) {
			...
			/* 47 */ p.sendMessage(
					"§6§lRank: §7Você ganhou o Kit: §aTimelord, Spiderman e Switcher§7, por upar de Rank.");
			/* 48 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.timelord");
			/* 49 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.spiderman");
		...
		/* 60 */ if (value == 10000) {
			...
			/* 63 */ p.sendMessage(
					"§6§lRank: §7Você ganhou o Kit: §aForcefield, Rain, Phantom e C4§7, por upar de Rank.");
			/* 64 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.forcefield");
			/* 65 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.rain");
			/* 66 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
					"pex user " + p.getName() + " add kit.phantom");
			/* 67 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
