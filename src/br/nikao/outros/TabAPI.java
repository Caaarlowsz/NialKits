...
/*    */ public class TabAPI
/*    */ {
	/*    */ public static void AttTaba(Player p)/*    */ throws SQLException
	/*    */ {
		/* 21 */ if (isPlayerRightVersion(p)) {
			...
			/* 25 */ IChatBaseComponent header = ChatSerializer
					.a("{'text': '\n§f§l§c§lSTOMPA§8§l-§e§lKITS§7 \nServidor de KitPvP\n'}");
			/* 26 */ IChatBaseComponent footer = ChatSerializer.a("{'text': ' \n§7Players: §e"
					+ Bukkit.getOnlinePlayers().length + "§7/§e" + Bukkit.getMaxPlayers() + " §8| §7Ping: §e" + ep.ping
					+ " §8| §7Seu Kit: §e" + KitAPI.getkit(p) + "\n§bSkype: §3stompa.kits'}");
