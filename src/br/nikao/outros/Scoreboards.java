...
/*    */ {
	...
	/*    */ {
		/* 12 */ ScoreboardAPI score = new ScoreboardAPI(
				Main.getInstance().getConfig().getString("Scoreboard").replace("&", "§"));
		...
		/* 24 */ score.adicionarLinha(
				"§c➟ §f§lJogadores: §e" + Bukkit.getOnlinePlayers().length + "/" + Bukkit.getMaxPlayers(),
				Integer.valueOf(2));
