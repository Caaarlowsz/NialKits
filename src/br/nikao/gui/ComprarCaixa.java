...
/*     */ {
	...
	/*     */ public void Caixa(InventoryClickEvent e)/*     */ throws java.sql.SQLException
	/*     */ {
				...
				/* 73 */ if (e.getCurrentItem().isSimilar(Ferro)) {
					...
					/* 75 */ if (p.hasPermission("caixa.ferro")) {
						/* 76 */ if (value >= 10000) {
							...
							/*     */
							/* 87 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add caixa.ferro");
				...
				/* 101 */ if (e.getCurrentItem().isSimilar(Ouro)) {
					...
					/* 103 */ if (p.hasPermission("caixa.ouro")) {
						/* 104 */ if (value >= 20000) {
							...
							/*     */
							/* 115 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add caixa.ouro");
				...
				/* 130 */ if (e.getCurrentItem().isSimilar(Esmeralda)) {
					...
					/* 132 */ if (p.hasPermission("caixa.esmeralda")) {
						/* 133 */ if (value >= 30000) {
							...
							/*     */
							/* 144 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add caixa.esmeralda");
