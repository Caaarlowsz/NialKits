...
/*     */ {
	...
	/*     */ {
		...
		/* 139 */ if ((e.getMaterial() == org.bukkit.Material.CHEST)
				&& (e.getItem().getType() == org.bukkit.Material.CHEST)
	...
	/*     */ {
		...
		/* 399 */ vidrometa
				.setDisplayName(br.nikao.Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§"));
		...
		/* 468 */ ninjameta
				.setLore(Lore("§eTransforme-se §eem §eum §eninja §ee §eteleporte-se §epara §eseu §einimigo"));
		...
		/* 487 */ grandpameta
				.setLore(Lore("§eBata §eem §eseus §einimigos §ecom §esua §evarinha §ee §efaça §eeles §evoarem"));
		...
		/* 511 */ anchormeta
				.setLore(Lore("§eNão §eleve §erepulsão §eao §elevar §eum §ehit, §ee §enão §ede §erepulsão"));
		...
		/* 541 */ switchermeta.setLore(
				Lore("§eJogue §euma §ebolinha §ede §eneve §eem §eseu §einimigo §ee §etroque §ede §elugar §ecom §eele"));
		...
		/* 565 */ reapermeta.setLore(Lore(
				"§eClique §ecom §eo §ebotão §edireito §eem §eseu §einimigo §ee §efaça §eele §eficar §ecom §eefeito §ewhiter"));
		...
		/* 571 */ ryumeta.setLore(
				Lore("§eJogue §euma §ebolinha §ede §eneve §ee §edeixe §eseus §einimigos §ecom §eefeitos §ecabulosos"));
		...
		/* 589 */ deshfiremeta.setLore(Lore(
				"§eClique §ena §esua §eredstone §ee §etaque §efogo §eem §etodos §eos §eplayers §ea §esua §evolta"));
		...
		/* 595 */ criticalmeta
				.setLore(Lore("§eTenha §e33% §ede §echance §ede §edar §eum §egolpe §ecritico §eem §eseu §eoponente"));
		...
		/* 643 */ rainmeta.setLore(
				Lore("§eClique §ecom §esua §eflecha §ee §efaça §ecair §eflechas §ena §ecabeça §ede §eseus §einimigos"));
