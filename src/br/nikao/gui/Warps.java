...
/*     */ {
	...
	/*     */ {
		...
		/* 51 */ if ((e.getMaterial() == Material.PAPER) && (e.getItem().getType() == Material.PAPER)
		...
		/* 59 */ if ((e.getCurrentItem() != null) && (e.getCurrentItem().getItemMeta() != null)) {
			...
			/* 62 */ if (inv.getTitle().equalsIgnoreCase("§6§l§nWarps")) {
				...
				/* 85 */ if (e.getCurrentItem().isSimilar(Eventos)) {
					...
					/* 92 */ vidrometa.setDisplayName(
							Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§"));
