...
/*     */ {
	...
	/*     */ {
		...
		/* 67 */ if ((e.getMaterial() == Material.EXP_BOTTLE) && (e.getItem().getType() == Material.EXP_BOTTLE)
				&& (br.nikao.outros.KitAPI.getkit(p) == "Nenhum")
				&& (e.getItem().getItemMeta().getDisplayName() == "§7» §f§lLoja §8§l(§6§nXP§8§l)")) {
	...
	/*     */ public void Sucesso(Player p, String k) {
		...
		/* 287 */ org.bukkit.Bukkit.getServer().dispatchCommand(org.bukkit.Bukkit.getServer().getConsoleSender(),
				"pex user " + p.getName() + " add kit." + k);
