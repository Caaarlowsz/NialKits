...
/*     */ {
	...
	/*     */ {
		...
		/* 67 */ if ((e.getMaterial() == Material.ENCHANTMENT_TABLE)
				&& (e.getItem().getType() == Material.ENCHANTMENT_TABLE)
				&& (br.nikao.outros.KitAPI.getkit(p) == "Nenhum")) {
			...
			/* 73 */ vidrometa
					.setDisplayName(Main.getInstance().getConfig().getString("NomeDoServidor").replace("&", "§"));
		...
		/* 130 */ if ((e.getCurrentItem() != null) && (e.getCurrentItem().getItemMeta() != null)) {
			...
			/*     */ {
				...
				/* 151 */ if (e.getCurrentItem().isSimilar(Ferro)) {
					...
					/* 158 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
							"pex user " + p.getName() + " remove caixa.ferro");
					...
					/*     */ {
						...
						/*     */ {
							...
							/* 165 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit);
							/* 166 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex reload");
							/* 167 */ p.playSound(p.getLocation(), org.bukkit.Sound.FIREWORK_BLAST, 2.0F, 2.0F);
							/* 168 */ p.getLocation().getWorld().spawnEntity(p.getLocation(),
				...
				/* 175 */ if (e.getCurrentItem().isSimilar(Ouro)) {
					...
					/* 183 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
							"pex user " + p.getName() + " remove caixa.ouro");
					...
					/*     */ {
						...
						/*     */ {
							...
							/* 190 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit);
							/* 191 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit2);
							/* 192 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex reload");
							/* 193 */ p.playSound(p.getLocation(), org.bukkit.Sound.FIREWORK_BLAST, 2.0F, 2.0F);
							/* 194 */ p.getLocation().getWorld().spawnEntity(p.getLocation(),
									org.bukkit.entity.EntityType.FIREWORK);
				...
				/* 201 */ if (e.getCurrentItem().isSimilar(Esmeralda)) {
					...
					/* 210 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
							"pex user " + p.getName() + " remove caixa.esmeralda");
					/* 211 */ p
							.sendMessage("§7§l[§e§lCaixa§7§l] §7§lVocê abriu a caixa §e§lEsmeralda§7§l, e seu Kit é: ");
					/* 212 */ Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable()
					/*     */ {
						/*     */ public void run()
						/*     */ {
							/* 216 */ p.sendMessage(
									"§7§l[§e§lCaixa§7§l] §3§l" + kit + " §7, §3§l" + kit2 + " §7e §3§l" + kit3);
							/* 217 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit);
							/* 218 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit2);
							/* 219 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex user " + p.getName() + " add kit." + kit3);
							/* 220 */ Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
									"pex reload");
							/* 221 */ p.playSound(p.getLocation(), org.bukkit.Sound.FIREWORK_BLAST, 2.0F, 2.0F);
							/* 222 */ p.getLocation().getWorld().spawnEntity(p.getLocation(),
									org.bukkit.entity.EntityType.FIREWORK);
