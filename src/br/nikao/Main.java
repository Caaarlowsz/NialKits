...
/*     */ {
	...
	/*     */ public void onEnable() {
		...
		/* 122 */ Bukkit.getServer().getConsoleSender()
				.sendMessage(getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l>> §aFoi ativado com sucesso");
		/*     */
		...
		/*     */ {
			...
			/*     */ {
				...
				/* 129 */ int j = (arrayOfPlayer = Bukkit.getOnlinePlayers()).length;
				for (int i = 0; i < j; i++) {
	...
	/*     */ {
		/* 140 */ Bukkit.getServer().getConsoleSender()
				.sendMessage(getInstance().getConfig().getString("NomeDoServidor").replace("&", "§")
						+ " §6§l>> §cFoi desativado com sucesso");
		/*     */
		/*     */ Player[] arrayOfPlayer;
	...
	/*     */ public void Eventos() {
		...
		/* 225 */ Bukkit.getServer().getPluginManager().registerEvents(new br.nikao.comandos.ComandoInexistente(),
				this);
