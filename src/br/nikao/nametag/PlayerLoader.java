...
/*     */ {
	...
	/*     */ static void addPlayer(String name, String operation, String value) {
		...
		/* 58 */ int j = (arrayOfString = (String[]) buffer.toArray(new String[buffer.size()])).length;
		for (int i = 0; i < j; i++) {
	...
	/*     */ static void removePlayer(String name, String operation) {
		...
		/*     */ String[] arrayOfString;
		/* 113 */ int j = (arrayOfString = (String[]) buffer.toArray(new String[buffer.size()])).length;
		for (int i = 0; i < j; i++) {
			String line = arrayOfString[i];
	...
	/*     */ static LinkedHashMap<String, String> getPlayer(String name) {
		...
		/* 137 */ String[] arrayOfString;
		int j = (arrayOfString = (String[]) playerMap.keySet().toArray(new String[playerMap.keySet().size()])).length;
		for (int i = 0; i < j; i++) {
			String key = arrayOfString[i];
			/* 138 */ if (key.equals(name)) {
				/* 139 */ return playerMap.get(key);
				/*     */ }
			/*     */ }
		/* 142 */ return null;
		/*     */ }
