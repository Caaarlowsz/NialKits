...
/*    */ {
	...
	/*    */
	/*    */ public NameTagChangeEvento(String Jogador, String OldPrefix, String OldSuffix, String NewPrefix,
			String NewSuffix, NametagChangeType Tipo, NametagChangeReason Reação) {
