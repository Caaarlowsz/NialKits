...
/*    */ {
			...
			/*    */ public void run() {
				...
				/* 28 */ if (JogadorData2 != null) {
					/* 29 */ for (String JogadorNome : JogadorData2.keySet()) {
						/* 30 */ LinkedHashMap<String, String> JogadorData = JogadorData2.get(JogadorNome);
	...
	/*    */ public static void SetarNameTagHard(String Jogador, String Prefix, String Suffix,
		...
		/* 47 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
	...
	/*    */ public static void SetarNameTagSoft(String Jogador, String Prefix, String Suffix,
			NameTagChangeEvento.NametagChangeReason Reacão) {
		/* 56 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
