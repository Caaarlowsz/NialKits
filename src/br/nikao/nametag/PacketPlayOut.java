...
/*     */ {
	...
	/*     */ static {
		/*     */ try {
			...
			/*     */
			/* 25 */ Class<?> typeCraftPlayer = Class
			...
			/*     */
			/* 29 */ Class<?> typePlayerConnection = Class
			...
			/* 35 */ sendPacket = typePlayerConnection.getMethod("sendPacket",
	...
	/*     */
	/*     */
	/*     */ PacketPlayOut(String name, String prefix, String suffix, Collection<String> players, int paramInt)
	...
	/*     */
	/*     */ PacketPlayOut(String name, Collection<String> players, int paramInt)
			/*     */ throws ClassNotFoundException, IllegalAccessException, InstantiationException,
			NoSuchMethodException, NoSuchFieldException, InvocationTargetException
	/*     */ {
	...
	/*     */ {
		...
		/* 99 */ ((PacketPlayOut) f.get(this.packet)).addAll(col);
		/*     */ }

	/*     */
	/*     */ private static String getPacketTeamClasspath() {
		/* 103 */ if ((Integer.valueOf(version.split("_")[1]).intValue() < 7)
