...
/*     */ {
	...
	/*     */ {
		/* 12 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 14 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
				...
				/* 17 */ if (!e.isCancelled()) {
					/* 18 */ NametagManager.Atualizar(Jogador, Prefix, "");
					/* 19 */ PlayerLoader.update(Jogador, Prefix, "");
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void setSuffix(String Jogador, final String Suffix) {
		/* 26 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 28 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
				...
				/* 30 */ if (!e.isCancelled()) {
					/* 31 */ NametagManager.Atualizar(Jogador, "", Suffix);
					/* 32 */ PlayerLoader.update(Jogador, "", Suffix);
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void setNametagHard(String Jogador, final String Prefix, final String Suffix) {
		/* 41 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 43 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
				...
				/* 48 */ if (!e.isCancelled()) {
					/* 49 */ NametagManager.Overlap(Jogador, Prefix, Suffix);
					/* 50 */ PlayerLoader.overlap(Jogador, Prefix, Suffix);
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void SetNameTagSoft(String Jogador, final String Prefix, final String Suffix) {
		/* 57 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 59 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
				...
				/* 64 */ if (!e.isCancelled()) {
					/* 65 */ NametagManager.Atualizar(Jogador, Prefix, Suffix);
					/* 66 */ PlayerLoader.update(Jogador, Prefix, Suffix);
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void UpdateNameTagHard(String Jogador, final String Prefix, final String Suffix) {
		/* 73 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 75 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
						NametagAPI.PegarSuffix(Jogador), Prefix, Suffix, NameTagChangeEvento.NametagChangeType.HARD,
						NameTagChangeEvento.NametagChangeReason.CUSTOM);
				/*     */
				/* 77 */ Bukkit.getServer().getPluginManager().callEvent(e);
				/* 78 */ if (!e.isCancelled()) {
					/* 79 */ NametagManager.Overlap(Jogador, Prefix, Suffix);
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void UpdateNameTagSoft(String Jogador, final String Prefix, final String Suffix) {
		/* 86 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 88 */ NameTagChangeEvento e = new NameTagChangeEvento(Jogador, NametagAPI.PegarPrefix(Jogador),
						NametagAPI.PegarSuffix(Jogador), Prefix, Suffix, NameTagChangeEvento.NametagChangeType.SOFT,
						NameTagChangeEvento.NametagChangeReason.CUSTOM);
				/* 89 */ Bukkit.getServer().getPluginManager().callEvent(e);
				/* 90 */ if (!e.isCancelled()) {
					/* 91 */ NametagManager.Atualizar(Jogador, Prefix, Suffix);
					/*     */ }
				/*     */ }
			/*     */ });
		/*     */ }
	...
	/*     */ public static void ResetarNameTag(String Jogador) {
		/* 98 */ Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getInstance(), new Runnable() {
			/*     */ public void run() {
				/* 100 */ NametagManager.Limpar(Jogador);
				/* 101 */ PlayerLoader.removePlayer(Jogador, "");
				/*     */
				/* 103 */ org.bukkit.entity.Player targetPlayer = Bukkit.getPlayerExact(Jogador);
				/* 104 */ if (targetPlayer != null) {
					String[] arrayOfString;
					/* 105 */ int j = (arrayOfString = (String[]) Array.groups.keySet()
							.toArray(new String[Array.groups.keySet().size()])).length;
					for (int i = 0; i < j; i++) {
						String key = arrayOfString[i];
						/*     */
						/* 107 */ if (targetPlayer.hasPermission(key)) {
							/* 108 */ String prefix = (String) (Array.groups.get(key)).get("prefix");
							/*     */
							/* 110 */ String suffix = (String) (Array.groups.get(key)).get("suffix");
							/*     */
							/* 112 */ if (prefix != null) {
							...
							/* 116 */ if (suffix != null) {
								...
								/*     */ }
							/*     */
							/* 120 */ Array.SetarNameTagHard(Jogador, prefix, suffix,
