...
/*     */ {
	...
	/*     */ {
		...
		/* 23 */ List<String> List = teams.get(Team);
		/* 24 */ if (List != null) {
			/* 25 */ List.add(Jogador);
	...
	private static boolean removeTeam(String Nome) {
		...
		/* 44 */ int j = (arrayOfTeamInfo = (TeamInfo[]) teams.keySet().toArray(new TeamInfo[teams.size()])).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
	...
	/*     */ private static TeamInfo RemoverTeam(String Jogador) {
		/*     */ TeamInfo[] arrayOfTeamInfo;
		/* 60 */ int j = (arrayOfTeamInfo = (TeamInfo[]) teams.keySet().toArray(new TeamInfo[teams.size()])).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
			/* 61 */ List<String> list = teams.get(Team);
			/* 62 */ String[] arrayOfString;
			int m = (arrayOfString = (String[]) list.toArray(new String[list.size()])).length;
			for (int k = 0; k < m; k++) {
				String Tags = arrayOfString[k];
	...
	/*     */ private static TeamInfo getTeam(String name) {
		TeamInfo[] arrayOfTeamInfo;
		/* 81 */ int j = (arrayOfTeamInfo = (TeamInfo[]) teams.keySet().toArray(new TeamInfo[teams.size()])).length;
		for (int i = 0; i < j; i++) {
			TeamInfo team = arrayOfTeamInfo[i];
	...
	/*     */ private static TeamInfo[] PegarTeams() {
		...
		/* 91 */ int at = 0;
		/* 92 */ TeamInfo[] arrayOfTeamInfo1;
		int j = (arrayOfTeamInfo1 = (TeamInfo[]) teams.keySet().toArray(new TeamInfo[teams.size()])).length;
		for (int i = 0; i < j; i++) {
			TeamInfo team = arrayOfTeamInfo1[i];
			/* 93 */ list[at] = team;
			/* 94 */ at++;
			/*     */ }
		/* 96 */ return list;
	...
	/*     */ {
		/* 101 */ List<String> List = teams.get(Team);
		/* 102 */ if (List != null) {
	...
	/*     */
	/*     */
	/* 131 */ public static void Limpar(String player) {
		RemoverTeam(player);
	}
	...
	/*     */ public static String PegarPrefix(String Jogador) {
		/*     */ TeamInfo[] arrayOfTeamInfo;
		/* 135 */ int j = (arrayOfTeamInfo = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
			/* 136 */ String[] arrayOfString;
			int m = (arrayOfString = PegarTeamJogadores(Team)).length;
			for (int k = 0; k < m; k++) {
				String Tags = arrayOfString[k];
	...
	/*     */ public static String PegarSuffix(String Jogador) {
		TeamInfo[] arrayOfTeamInfo;
		/* 146 */ int j = (arrayOfTeamInfo = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
			/* 147 */ String[] arrayOfString;
			int m = (arrayOfString = PegarTeamJogadores(Team)).length;
			for (int k = 0; k < m; k++) {
				String Tags = arrayOfString[k];
	...
	/*     */ private static TeamInfo Pegar(String Prefix, String Suffix) {
		/* 177 */ Atualizar();
		/*     */
		/* 179 */ Integer[] arr$ = (Integer[]) list.toArray(new Integer[list.size()]);
		int len$ = arr$.length;
		for (int i$ = 0; i$ < len$; i$++) {
	...
	/*     */ private static void Atualizar() {
		TeamInfo[] arrayOfTeamInfo;
		/* 211 */ int j = (arrayOfTeamInfo = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
			/* 212 */ int Entry = -1;
			/*     */ try {
	...
	/*     */ public static void MandarTeamsParaJogador(Player Jogador) {
		/*     */ try {
			/*     */ TeamInfo[] arrayOfTeamInfo;
			/* 227 */ int j = (arrayOfTeamInfo = PegarTeams()).length;
			for (int i = 0; i < j; i++) {
				TeamInfo Team = arrayOfTeamInfo[i];
				/* 228 */ PacketPlayOut PacketPlayOut = new PacketPlayOut(Team.PegarNome(), Team.PegarPrefix(),
						Team.PegarSuffix(), new ArrayList<>(), 0);
				/*     */
				/* 230 */ PacketPlayOut.sendToPlayer(Jogador);
				/* 231 */ PacketPlayOut = new PacketPlayOut(Team.PegarNome(), Arrays.asList(PegarTeamJogadores(Team)),
						3);
				/*     */
	...
	/*     */ private static void MandarPacketsAdicionarTeams(TeamInfo Team) {
		/*     */ try {
			...
			/* 245 */ int j = (arrayOfPlayer = Bukkit.getOnlinePlayers()).length;
			for (int i = 0; i < j; i++) {
				Player Jogadores = arrayOfPlayer[i];
				/* 246 */ PacketPlayOut PacketPlayOut = new PacketPlayOut(Team.PegarNome(), Team.PegarPrefix(),
						Team.PegarSuffix(), new ArrayList<>(), 0);
	...
	/*     */ {
		...
		/* 259 */ TeamInfo[] localObject;
		int j = (localObject = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team2 = localObject[i];
			/* 260 */ if (Team2 == Team) {
				/* 261 */ Cont = true;
				/*     */ }
			/*     */ }
		...
		/*     */ {
			Player[] localPlayers;
			/* 269 */ j = (localPlayers = Bukkit.getOnlinePlayers()).length;
			for (int i = 0; i < j; i++) {
				Player Jogadores = localPlayers[i];
				/* 270 */ PacketPlayOut PacketPlayOut = new PacketPlayOut(Team.PegarNome(), Team.PegarPrefix(),
	...
	/*     */ {
		...
		/*     */ {
			Player[] localPlayers;
			/* 292 */ j = (localPlayers = Bukkit.getOnlinePlayers()).length;
			for (int i = 0; i < j; i++) {
				Player Jogadores = localPlayers[i];
				/* 293 */ PacketPlayOut PacketPlayOut = new PacketPlayOut(Team.PegarNome(),
	...
	/*     */ {
		...
		/* 307 */ TeamInfo[] localObject;
		int j = (localObject = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team2 = localObject[i];
			/* 308 */ if (Team2 == Team) {
				String[] arrayOfString;
				/* 309 */ int m = (arrayOfString = PegarTeamJogadores(Team2)).length;
				for (int k = 0; k < m; k++) {
					String NomeDoJogador = arrayOfString[k];
		...
		/*     */ {
			Player[] localPlayers;
			/* 321 */ j = (localPlayers = Bukkit.getOnlinePlayers()).length;
			for (int i = 0; i < j; i++) {
				Player Jogadores = localPlayers[i];
				/* 322 */ PacketPlayOut PacketPlayOut = new PacketPlayOut(Team.PegarNome(),
	...
	/*     */ public static void Resetar() {
		TeamInfo[] arrayOfTeamInfo;
		/* 333 */ int j = (arrayOfTeamInfo = PegarTeams()).length;
		for (int i = 0; i < j; i++) {
			TeamInfo Team = arrayOfTeamInfo[i];
			/* 334 */ removeTeam(Team);
			/*     */ }
...
/*
 * Location:
 * C:\Users\Vini\Downloads\KitPvP.jar!\br\nikao\nametag\NametagManager.class
